...
#Podemos observar que los estados que se consideran muy liberales son estados con relativamente pocos encuestados.

#Obtenemos el intervalo de confianza al 95%:

quantile(data$very_liberal, c(0.025, 0.975))

# Obtenemos el intervalo de confianza del 95% para la proporción:
...
# Simular 10000 valores de la distribución Beta(8, 160)
...
hist(samples, breaks = 50, main = 'Simulación de la Distribución Beta(8, 160)', xlab = 'Valor', ylab = 'Frecuencia')

#La forma de la distribución Beta(8, 160) será sesgada hacia la izquierda, ya que el valor de beta es sustancialmente mayor que alpha, indicando que la probabilidad previa de ser 'muy liberal' es baja. 
```
