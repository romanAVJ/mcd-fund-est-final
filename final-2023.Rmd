...
(WIP): add simulation and compare it with the theoretical p-value
...
this chunk must have a bigger plot
...
```{r}
model_stan <- file.path("stan", "beta_binomial_model.stan") |> cmdstanr::cmdstan_model()
model_stan
```
